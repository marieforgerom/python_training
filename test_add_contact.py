...
class TestAddContact(unittest.TestCase):
    ...
    def test_add_contact(self):
        ...
        self.add_new_contact(wd, Contact("etrt", "fghfh", "yuiui", "tyt", "rtet", "cvgfhfh", "dfhdhd", "345565", "234345",
    ...
    def add_new_contact(self, wd, contact):
        ...
        wd.find_element_by_xpath("//select[@name='amonth']/option[@value='"+contact.amonth+"']").click()
